 ...
 *
 *  Runs through the list of attributes in the GATT database and replaces
 *  all addresses in the ccc cfg entries that matches the specified private
 *  address with the provided public address.
 *
